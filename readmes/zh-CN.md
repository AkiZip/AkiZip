...
- **多语言界面**——随附 10 多种语言的翻译（包括英语、中文、西班牙语、法语、意大利语、俄语等），通过 [Weblate](https://hosted.weblate.org/engage/akizip/) 贡献。
...
```bash
./update-po.sh                              # 将字符串提取到 po/akizip.pot，并 msgmerge po/LINGUAS 中的所有目录文件
